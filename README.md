...
You can add a workspace as a volume directory with the argument *-v /your-path/workspace/://workspace* like this :
    ...
    docker run -it --rm -v /your-path/workspace/://workspace kdelfour/cloud9-docker
...
And run
    ...
    sudo docker run -d -v /your-path/workspace/://workspace kdelfour/cloud9-docker $USER/cloud9-docker:latest
